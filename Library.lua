...
function Library:CreateWindow(WindowInfo)
    ...
    if TabButtonsStyle.CornerRadius == nil then
        TabButtonsStyle.CornerRadius = WindowInfo.CornerRadius
    end
        ...
        local function AddTabbox(self, Info)
            ...
            function Tabbox:AddTab(Name, IconName)
                ...
                function Tab:UpdateCorners()
                    ...
                    ButtonCorner.TopLeftRadius = UDim.new(0, Radius)
                    ButtonCorner.TopRightRadius = UDim.new(0, Radius)
                    ButtonCorner.BottomRightRadius = UDim.new(0, Radius)
                    ButtonCorner.BottomLeftRadius = UDim.new(0, Radius)
                end
