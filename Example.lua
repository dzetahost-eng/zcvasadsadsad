...
local repo = "https://raw.githubusercontent.com/dzetahost-eng/zcvasadsadsad/refs/heads/main/"

-- Use the local modified Library.lua if it exists in the executor workspace, otherwise fall back to the repo
local Library
if readfile and isfile and isfile("Library.lua") then
...
local Window = Library:CreateWindow({
	...
	-- Big corner radius so the rounded edges are clearly visible
	CornerRadius = 12,

	-- NEW: custom window background transparency (0 = opaque, 1 = invisible)
...
local LeftGroupBox = Tabs.Main:AddGroupbox({
	...
	-- NEW: custom background transparency for groupboxes (sections)
...
MenuGroup:AddSlider("WindowTransparencySlider", {
